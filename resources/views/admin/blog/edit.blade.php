...
@section('title', 'Modifier l\'Article - ' . $blogPost->title)
...
@section('content')
    <div class="admin-page-header">
        ...
        <div class="header-actions">
            ...
            <form action="{{ route('admin.blog-posts.destroy', $blogPost) }}" method="POST" style="display: inline;" 

                ...
                <div>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <textarea id="description" 
                                  ...
                                  style="width: 100%; padding: 0.8rem; border: 1px solid var(--border-color); border-radius: 6px; background: var(--bg-card); color: var(--text-primary);">{{ old('description', $promotion->description) }}</textarea>
                        @error('description')
                            <span style="color: #ff6b6b; font-size: 0.9rem; margin-top: 0.5rem; display: block;">
                                {{ $message }}
                            </span>
                ...
                <div>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <div style="max-height: 200px; overflow-y: auto; border: 1px solid var(--border-color); border-radius: 6px; padding: 1rem; background: var(--bg-card);">
                            @php
                                $selectedCategories = old('categories', $promotion->categories->pluck('id')->toArray());
                            @endphp

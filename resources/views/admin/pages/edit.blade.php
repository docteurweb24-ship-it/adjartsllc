        ...
        <form action="{{ route('admin.pages.update', $page) }}" method="POST">
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea name="content" rows="12" required 
                          style="width: 100%; padding: 0.8rem; background: rgba(255,255,255,0.05); border: 1px solid rgba(212,175,55,0.3); border-radius: 6px; color: var(--cream); resize: vertical;">{{ $page->content }}</textarea>
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea name="meta_description" rows="3" 
                          style="width: 100%; padding: 0.8rem; background: rgba(255,255,255,0.05); border: 1px solid rgba(212,175,55,0.3); border-radius: 6px; color: var(--cream); resize: vertical;">{{ $page->meta_description }}</textarea>
            </div>

            <div style="margin-bottom: 2rem;">
                <label style="display: flex; align-items: center; gap: 0.5rem; color: var(--cream);">
                    <input type="checkbox" name="is_active" {{ $page->is_active ? 'checked' : '' }} style="transform: scale(1.2);">
                    ✅ Page active
                </label>
            </div>
